...
class DjangoMultiDetectionSystem:
    def __init__(self):
        # Load YOLO model for person and phone detection
    ...
    def run_video(self, video_path, save_interval=5):
        """Run detection on video file and save to database"""
        ...
        while True:
            ...
            # Auto-save if phone users detected
            if results['phone_users']:
                current_time = datetime.now()
                time_diff = (current_time - last_save_time).total_seconds()
...
if __name__ == "__main__":
    ...
    # detector.run_video('input_video.mp4', save_interval=3)
